    ...
    >
      <div class="w-full max-w-2xl bg-white app-dark:bg-gray-900 rounded-lg shadow-2xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-4 flex justify-between items-center">
          <div>
            <h2 class="text-white font-bold text-2xl">Comprar Modelo</h2>
        ...
        <div class="p-6 space-y-6">
          ...
          <!-- Price Section -->
          <div v-if="model.forSale" class="bg-gradient-to-br from-green-50 to-green-100 app-dark:from-green-900/20 app-dark:to-green-800/20 border-2 border-green-300 app-dark:border-green-700 rounded-lg p-6">
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-yellow-700 app-dark:text-yellow-300 mt-1">
                  Este modelo actualmente no está en venta. Puedes intentar comprar una licencia de uso en su lugar.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="flex gap-3">
            ...
            >
              ...
              <span>{{ isProcessing ? 'Procesando...' : `Comprar por ${model.price} AVAX` }}</span>
            </button>
          </div>
        </div>
      </div>
