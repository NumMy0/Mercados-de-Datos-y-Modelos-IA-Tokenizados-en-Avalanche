      ...
      >
        ...
        <div class="p-6 space-y-6 max-h-[60vh] overflow-y-auto">
          ...
          <div v-else-if="activeTab === 'model'">
            ...
            <!-- Not for sale -->
            <div v-else class="bg-yellow-50 app-dark:bg-yellow-900/20 border border-yellow-300 app-dark:border-yellow-700 rounded-lg p-6">
